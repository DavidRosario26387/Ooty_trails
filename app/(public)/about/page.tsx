...
export const metadata: Metadata = {
  ...
  description:
    "Ooty Trails is a family-run taxi service in Ooty offering safe drivers, transparent pricing and genuine local expertise for a tourist-friendly experience.",
};
...
const VALUES = [
  ...
  { icon: BadgeIndianRupee, title: "Transparent pricing", desc: "Clear base fares and per-km rates shared upfront — no hidden charges, ever." },
    ...
    <>
      <section className="bg-gradient-to-br from-brand-600 to-brand-800 py-16 text-white sm:py-20">
        <div className="container-page max-w-3xl">
          <p className="eyebrow text-accent-300">About Ooty Trails</p>
          <h1 className="mt-2 font-display text-4xl font-extrabold sm:text-5xl">
            A family fleet, exploring Ooty the right way
          </h1>
          <p className="mt-5 text-lg text-brand-50/90">
            We started Ooty Trails to solve a simple problem tourists face every day — finding a reliable,
      ...
      <section className="section bg-white">
        <div className="container-page grid items-center gap-12 lg:grid-cols-2">
          ...
          <div>
            {/* Replace with image of the Ooty Trails family / drivers with their cabs */}
